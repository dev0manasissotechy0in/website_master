...
<main id="main" class="main">
    @component('admin.partials.page-head',['breadcrumb'=>['Dashboard'=>'/admin/dashboard']])
        ...
        @slot('add_btn') <a href="{{url('admin/blog-category/create')}}" class="btn btn-primary btn-sm rounded-pill align-self-center">+ Add New</a>  @endslot
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    @component('admin.partials.dataTables',['thead'=>
                        ['S NO.','Name','Blogs','Action']
                    ])
                        @slot('table_id') blogCategory-list @endslot
                    @endcomponent
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    var table = $("#blogCategory-list").DataTable({
        processing: true,
        serverSide: true,
        ajax: "blog-category",
        columns: [
            ...
            {data: 'blogs_count', name: 'blogs_count',sWidth: '50px'},
            {
                data: 'action',
                name: 'action',
                orderable: true,
