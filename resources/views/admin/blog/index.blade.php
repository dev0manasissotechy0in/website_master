...
<main id="main" class="main">
    @component('admin.partials.page-head',['breadcrumb'=>['Dashboard'=>'/admin/dashboard']])
        ...
        @slot('add_btn') <a href="{{url('admin/blogs/create')}}" class="btn btn-primary btn-sm rounded-pill align-self-center">+ Add New</a>  @endslot
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    @component('admin.partials.dataTables',['thead'=>
                        ['S No.','Title','Category','Status','Action']
                    ])
                        @slot('table_id') blogs-list @endslot
                    @endcomponent
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    var table = $("#blogs-list").DataTable({
        processing: true,
        serverSide: true,
        ajax: "blogs",
        columns: [
