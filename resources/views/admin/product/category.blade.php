...
<main id="main" class="main">
    @component('admin.partials.page-head',['breadcrumb'=>['Dashboard'=>'/admin/dashboard']])
        ...
        @slot('add_btn') <a href="{{url('admin/product-category/create')}}" class="btn btn-primary btn-sm rounded-pill align-self-center">+ Add New</a>  @endslot
        @slot('active') Product Category @endslot
    @endcomponent
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    @component('admin.partials.dataTables',['thead'=>
                        ['S NO.','Name','Products','Status','Action']
                    ])
                        @slot('table_id') productCategory-list @endslot
                    @endcomponent
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    var table = $("#productCategory-list").DataTable({
        processing: true,
        serverSide: true,
