...
<main id="main" class="main">
    @component('admin.partials.page-head',['breadcrumb'=>['Dashboard'=>'/admin/dashboard']])
        ...
        @slot('add_btn') <a href="{{url('admin/social-links/create')}}" class="btn btn-primary btn-sm rounded-pill align-self-center">+ Add New</a>  @endslot
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    @component('admin.partials.dataTables',['thead'=>
                        ...
                        @slot('table_id') social-list @endslot
                    @endcomponent
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    var table = $("#social-list").DataTable({
        processing: true,
        serverSide: true,
        ajax: "social-links",
        columns: [
