            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    @component('admin.partials.dataTables',['thead'=>
                        ['S NO.','Name','Email','Phone','Country','Status','Approved','Action']
                    ])
                        @slot('table_id') sellers-list @endslot
                    @endcomponent
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    var table = $("#sellers-list").DataTable({
        processing: true,
        serverSide: true,
        ajax: "sellers",
        columns: [
            ...
            {data: 'approved_seller', name: 'approved_seller',sWidth: '50px'},
            {
                data: 'action',
                name: 'action',
                orderable: true,
