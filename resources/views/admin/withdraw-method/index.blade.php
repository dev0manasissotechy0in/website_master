...
<main id="main" class="main">
    @component('admin.partials.page-head',['breadcrumb'=>['Dashboard'=>'/admin/dashboard']])
        @slot('title') Withdraw Methods @endslot
        @slot('add_btn') <a href="{{url('admin/withdraw-methods/create')}}" class="btn btn-primary btn-sm rounded-pill align-self-center">+ Add New</a>  @endslot
        @slot('active') Withdraw Methods @endslot
    @endcomponent
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    @component('admin.partials.dataTables',['thead'=>
                        ...
                        @slot('table_id') method-list @endslot
                    @endcomponent
                    </div>
                </div>
            </div>
